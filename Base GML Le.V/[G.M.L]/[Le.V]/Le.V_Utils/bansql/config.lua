...
Config.ForceSteam        = false    --Set to false if you not use steam auth
...
--LANGUAGE
Config.TextFr = {
	start         = "La Banlist à été charger avec succès !",
	starterror    = "ERREUR : La BanList ou l'historique n'a pas été charger nouvelle tentative.",
	banlistloaded = "La liste de ban a été charger avec succes.",
	historyloaded = "L'historique de la liste a été charger avec succes.",
	...
	alreadyban    = " étais déja bannie du serveur Alamo Shores pour : ",
	yourban       = "Tu as été bannis du serveur Alamo Shores pour : ",
	yourpermban   = "Tu as été bannis du serveur Alamo Shores permanance pour :  ",
