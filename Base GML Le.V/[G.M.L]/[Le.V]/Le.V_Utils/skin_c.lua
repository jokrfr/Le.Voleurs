...
function OpenSaveableMenu(submitCb, cancelCb, restrict)
	...
	OpenMenu(function(data, menu)
		...
		TriggerEvent('skinchanger:getSkin', function(skin)
			...
			TriggerEvent("esx:showAdvancedStreamedNotification", 'Panneau', 'Information', 'Votre personnage est bien enregistré, Bienvenue sur Atlas RP.', 'CHAR_FLOYD', 'spawn', 8)
...
RegisterNetEvent('open:skinchanger')
AddEventHandler('open:skinchanger', function(submitCb, cancelCb)
	OpenSaveableMenu(submitCb, cancelCb, nil)
end)
